...
const Navbar = () => {
  ...
  return (
    <section>
      ...
      {/* pc design  */}
      <div className='container mx-auto px-5 md:py-3 overflow-hidden md:px-0'>
        <div className='flex justify-between items-center'>
          <div className='flex items-center gap-10'>
            ...
            <div className='hidden md:flex md:text-[12px] lg:text-[14px] overflow-clip'>
          ...
          <div className='flex gap-2 text-[18px] md:text-[20px]'>
            <div className=''>
              {search ? <div className='hidden  max-w-[160px] md:flex items-center px-2 py-1 rounded-xl text-black border-[1px] border-[#77d330]'>
                <input className='outline-none px-1 py-1 text-[12px]' type="text" name="" id="" placeholder='Search' />
                <IoSearchOutline />
              </div> : <div className='py-2 hidden md:block'><IoSearchOutline  onClick={searchHandel} /></div>
