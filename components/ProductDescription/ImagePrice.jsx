...
import light1 from "@/public/LIght 10363.png";
import light2 from "@/public/Bulb 167922501518w-LED-Bulb-B22.png";
import light3 from "@/public/bulb IMG.png";
  ...
  return (
    <section className=" container mx-auto py-8">
      <div className="flex lg:flex-row flex-col  justify-between items-start">
        ...
        {/* Product Details (One Line Layout) */}
