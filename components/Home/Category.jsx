...
import HighBayLight from '../../assets/led-high-bay.jpg'
import FloodLight from '../../assets/floodlight.jpg'
import PanelLight from '../../assets/panel-light.jpg'
           ...
           <svg className='hover:bg-[#7DBF46] hover:text-white   transition-all' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" >
            ...
            <div className="category-card py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-center px-10 ">
                {categoryList.map((item,i) => (
                    <div key={i}>
                    <div  className="card border-1 border-[#2e2e2e] group-hover:shadow-green-700 group-hover:shadow-5xl transition-all delay-500 ease-in-out hover:border-[#1B6732] group">
                    <Image className='w-full h-auto' src={item.image}  style={{borderRadius: 5}}/>
                    <div className='text-center  px-3 py-5 group-hover:bg-[#2e2e2e] text-[#1B6732] group-hover:text-white hover: border-t-1 hover:shadow-gray-600 transition-all ease-in-out delay-700' >
