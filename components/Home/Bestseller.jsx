    ...
    <section className='bestseller container px-6 items-center align-middle'>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 px-2 sm:px-4 md:px-10 lg:px-20">
            ...
            {Array.from({ length: 6 }).map((_, i) => (
                <div key={i} className="">
                    <div className="">
                        <div className="w-full sm:w-auto md:w-auto  relative">
                            <Image className='' src={lights} alt="Best seller lighting product" width={500} height={500} priority quality={100} />
                            <div className="absolute top-2 left-2 bg-green-400 text-white text-xs font-bold px-2 py-1 rounded">New</div>
                            <div className="absolute top-10 left-2 bg-green-400 text-white text-xs font-bold px-2 py-1 rounded">10%</div>
                        </div>
