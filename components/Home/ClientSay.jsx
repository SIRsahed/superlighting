...
const ClientSay = () => {
  ...
  return (
    <section className='py-8 lg:py-12 px-10 md:px-16'>
        ...
        <div className=' grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-center px-10 py-10 '>
        {ClientSays.map((item,i) =>(
                  <div key={ i} className='card hover:border-1 border-gray-700 px-5 py-5 lg:px-8 lg:py-6 rounded-md transition-all delay-700 ease-in-out'>
                  <div className='flex items-center gap-3 mt-5  '>
                      <div>
                          <Image className='w-16 h-16 rounded-full border-1 border-[#2E2E2E]' src={item.image}/>
                      </div>
                      <div>
